...
lista_grupos.Add(new Grupos { Id = 1, Nombre = "LVGT", Descuento = 0.0m, Activo = true });
...
{
    public static decimal Promedio(Notas nota)
    {
        return (nota.Nota1 + nota.Nota2 + nota.Nota3 + nota.Nota4 + nota.Nota5) / 5;
    }
}
public class Grupos
{
